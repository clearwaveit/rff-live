    ...
    <main className="min-h-screen" ref={containerRef}>
      <section className="relative min-h-[60vh] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 mx-auto max-w-[1600px] px-[2%] pb-16">
          <h1 className="page-hero-title text-white text-4xl sm:text-6xl font-[700] tracking-tight">About Us</h1>
        </div>
      </section>

      <AboutIntro
        badge="ABOUT US"
        title="Combining synthetic biology, chemistry, and AI into an engine of discovery."
        accent=""
        ...
        <div className="mx-auto max-w-[1600px] px-4 sm:px-6 md:px-8 lg:px-[2%] py-16 md:py-24 lg:py-32 xl:py-40 2xl:py-48">
          <div className="flex flex-col md:flex-row gap-6 md:gap-12 lg:gap-24 xl:gap-32 2xl:gap-48 items-start">
            ...
            <div className="flex-1 max-w-full">
              <p className="about-mission-text font-[400] text-[#00272F] tracking-normal">
                We work to divert plastic from landfill and the natural environment, reintroducing it into productive use. <span className="font-[400]">Our goal is to reduce reliance on virgin mat</span><span className="font-[400] text-[#579C9C]">erials and support businesses in adopting recycled plastics with confidence and clarity.</span>
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative h-screen">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-end pb-16 md:pb-24 px-4">
          <span className="inline-flex items-center gap-2 rounded-[7px] bg-white/90 px-3 py-1.5 text-[12px] md:text-[14px] font-[400] text-[#024D5D] uppercase tracking-wide mb-12">
            <span className="inline-block h-3 w-3 rounded-sm bg-[#C0D790]" />
            Our Commitment
          </span>
          <p className="text-center text-white text-[14px] md:text-[26px] font-[700] leading-[36px] max-w-[1600px]">
      ...
      <section className="relative my-28">
        <div className="mx-auto max-w-[1600px] px-[2%] py-16 lg:py-24">
          <div className="flex flex-col items-center text-center max-w-[850px] mx-auto">
            <span className="inline-flex items-center gap-2 rounded-[7px] bg-[#F5F5F5] px-3 py-1.5 text-[12px] font-[400] text-[#579C9C] uppercase tracking-wide mb-8">
              Our Values
            </span>
          ...
          <div className="rounded-[12px] bg-[#EEF6F6] overflow-hidden relative">
            <div className="about-values grid grid-cols-1 md:grid-cols-2 items-start py-12 md:py-16 px-8 md:px-16">
              <div className="flex flex-col gap-6 w-full">
                <span className="inline-flex w-fit items-center gap-2 rounded-[8px] bg-white px-3 py-1.5 text-[12px] font-[400] text-[#024D5D] uppercase tracking-wide">
                  Our Story
                </span>
                <div className="space-y-4">
                  <h3 className="text-[#00272F] text-[24px] md:text-[32px] font-[700] leading-tight">Pioneering Sustainable Plastic Recycling</h3>
                  <p className="text-[#4E4E4E] text-[14px] md:text-[16px] font-[500] leading-relaxed">Founded with the aim of advancing recycling practices, Recycle for Future has grown from a small operation into a leading UK plastic recovery and reprocessing provider. Today, our facilities and team are dedicated to delivering reliable, modern materials management for a circular economy.</p>
                </div>
              </div>
